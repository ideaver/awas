...
import 'package:awas/view/user/user_list_view.dart';

class DashboardManagerView extends StatelessWidget {
  static const String routeName = '/dashboard-manager';

  const DashboardManagerView({super.key});
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'period of month',
                                    style:
                                        LightColors.subTitle2TextStyle.copyWith(
                                      color: LightColors.kBackgroundColor,
                                    ),
                                  ),
                                )
