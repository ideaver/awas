...
class FiveWhyQuestFormView extends StatefulWidget {
  const FiveWhyQuestFormView({Key? key}) : super(key: key);

  static const String routeName = '/five-why-quest';

  @override
  State<FiveWhyQuestFormView> createState() => _FiveWhyQuestFormViewState();
}

class _FiveWhyQuestFormViewState extends State<FiveWhyQuestFormView> {
      ...
      child: Column(
        children: [
          const SizedBox(
            ...
            child: ClipOval(
              child: AppImage(
                image: 'assets/setup_company.png',
