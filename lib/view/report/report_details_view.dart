...
import 'package:awas_core/res/widgets/status_chip_widget.dart';
      ...
      actions: [
        currentUserRole == RoleEnum.employee
            ...
            : currentUserRole == RoleEnum.manager
                ? IconButton(
                    onPressed: () {
                      Navigator.pushNamed(context, ReportFormView.routeName);
                    },
                    icon: const Icon(
                      Icons.edit,
                      color: LightColors.kDarkGreyColor,
    ...
    return ListView(
      ...
      children: [
        ...
        Text(
          ...
          style: LightColors.blackTextStyle.copyWith(
...
class MyImageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, ImageViewerView.routeName);
      },
      child: Container(
